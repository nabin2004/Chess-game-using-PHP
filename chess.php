...
<div class="square" id="a8" ondragover="DragOverhere(event)" ondrop="DropHere(event)"><img alt="" draggable="true" id="LBrook" ondragstart="DragStartHere(event)" src="./images/pieces/black/rook.png"/></div>
<div class="square" id="b8" ondragover="DragOverhere(event)" ondrop="DropHere(event)"><img alt="" class='Blackpawn8' draggable="true" id="Blackpawn18" ondragstart="DragStartHere(event)" src="./images/pieces/black/pawn.png"/></div>
